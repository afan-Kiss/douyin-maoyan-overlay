...
function sanitizeSettings(input) {
  ...
  s.pollIntervalMs = clamp(Number(s.pollIntervalMs) || 2000, 1000, 60000);
  // 上一版默认 3 秒；未单独改过的配置跟成 2 秒
  if (s.pollIntervalMs === 3000) s.pollIntervalMs = 2000;
  ...
  if (s.bubble.durationMs === 3000) s.bubble.durationMs = 2000;
