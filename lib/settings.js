...
const DEFAULT_SETTINGS = {
  ...
  bubble: {
    enabled: true,
    color: "#52e878",
    bgStart: "rgba(12, 40, 22, 0.94)",
    bgEnd: "rgba(18, 56, 30, 0.9)",
    borderColor: "rgba(82, 232, 120, 0.65)",
    shadowColor: "rgba(82, 232, 120, 0.35)",
    glowColor: "rgba(82, 232, 120, 0.45)",
    fontSize: 34,
    durationMs: 3000,
    floatHeight: 52,
    minDelta: 0.001,
...
function sanitizeSettings(input) {
  ...
  s.bubble.durationMs = clamp(Number(s.bubble.durationMs) || 3000, 500, 5000);
